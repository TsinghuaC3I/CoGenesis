...
def preprocess_old(
    ...
    # https://github.com/QwenLM/Qwen/blob/d275e5b91ae726779e24f437ff38bd85d16cec80/finetune.py#L125
    ...
    for i, source in enumerate(sources):
        ...
        for j, sentence in enumerate(source):
            ...
            _input_id = tokenizer(role).input_ids + nl_tokens + \
                tokenizer(sentence["value"].replace(system_message+"\n\n", "")).input_ids + [im_end] + nl_tokens
            input_id += _input_id
...
def train():
    ...
    if "1.5" not in model_args.model_name_or_path:
